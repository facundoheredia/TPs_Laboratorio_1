...
#define MP_OPCION_MAXIMA 10
#define MM_OPCION_MAXIMA 6
#define ML_OPCION_MAXIMA 4
#define MO_OPCION_MAXIMA 8
...
/// @brief FUNCION QUE MUESTRA UN ENCABEZADO DE TABLA CUANDO SE MUESTRA LOS CODIGOS DE VUELO
void encabezadoTablaCodigosDeVuelo (void);

/// @brief FUNCION QUE MUESTRA UN PIE DE PAGINA DE TABLA CUANDO SE MUESTRA LOS CODIGOS DE VUELO
void PieDePaginaTablaCodigosDeVuelo (void);

/// @brief FUNCION QUE MUESTRA UN ENCABEZADO DE TABLA CUANDO SE MUESTRA LOS TIPO DE PASAJERO
void encabezadoTablaTipoPasajero (void);

/// @brief FUNCION QUE MUESTRA UN PIE DE PAGINA DE TABLA CUANDO SE MUESTRA LOS TIPO DE PASAJERO
void PieDePaginaTablaTipoPasajero (void);

//	> FUNCION ORDENAR PASAJEROS
/// @brief FUNCION QUE MUESTRA EL MENU DE ORDENAMIENTOS
///
/// @return opcionManuValida int Devuelve la opcion elegida
